...
<head>
    <meta charset="utf-8"/>
    <title>蜡笔小新陪你一起看大象的鼻子为什么那么长</title>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="<?php echo u('entry.index')?>" style="color: white;margin-left: -14px">蜡笔小新</a>
                </h4>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo u("entry.changePass") ?>">修改密码</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo u("entry.destory")?>">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
